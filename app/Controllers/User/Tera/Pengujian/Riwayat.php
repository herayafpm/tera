...
namespace App\Controllers\User\Tera\Pengujian;
...
class Riwayat extends BaseController
{
  ...
  {
    $data['_view'] = 'user/tera/pengujian/riwayat/index';
    $data = array_merge($data, $this->data);
    $data['_title'] = "Riwayat Pengujian Tera";
    $data['_uri_datatable'] = base_url("user/tera/pengujian/riwayat/datatable");
  ...
  public function datatable()
  {
    ...
    if ($method == 'post') {
      ...
      $where = ['tera.tera_ketetapan_at !=' => null, 'tera.tera_status_bayar !=' => 0];
      $like = null;
