    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          <div class="col-md-4"><input class="form-control form-control-sm" type="text" id="admin_username" placeholder="Username / NIP (min. 3 karakter)" /></div>
...
<script>
  ...
  $(function() {
    ...
    $('#role_id').on('change clear', function() {
      var value = $(this).val();
      data.role_id = value;
      tabel.ajax.reload(null, function(data) {
        datas = json.data
