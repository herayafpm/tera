    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control col-sm-4 <?= ($_validation->hasError('aparatur_nama') ? "is-invalid" : "") ?>" id="aparatur_nama" name="aparatur_nama" placeholder="Masukkan nama" value="<?= old('aparatur_nama', $_aparatur['aparatur_nama']) ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" data-inputmask="'mask': '99999999 999999 9 999','removeMaskOnSubmit': true" class=" form-control col-sm-4 <?= ($_validation->hasError('aparatur_nip') ? "is-invalid" : "") ?>" id="aparatur_nip" name="aparatur_nip" placeholder="Masukkan NIP" value="<?= old('aparatur_nip', $_aparatur['aparatur_nip']) ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <select class="col-sm-4 custom-select <?= ($_validation->hasError('aparatur_pangkat') ? "is-invalid" : "") ?>" id="aparatur_pangkat" name="aparatur_pangkat">
            ...
            <?php foreach ($_pangkats as $pangkat) : ?>
              <option value="<?= $pangkat ?>" <?= (old('aparatur_pangkat', $_aparatur['aparatur_pangkat']) == $pangkat) ? "selected" : "" ?>><?= $pangkat ?></option>
            <?php endforeach ?>
          </select>
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <select class="col-sm-4 custom-select <?= ($_validation->hasError('jabatan_id') ? "is-invalid" : "") ?>" id="jabatan_id" name="jabatan_id">
            ...
            <?php foreach ($_jabatans as $jabatan) : ?>
              <option value="<?= $jabatan['jabatan_id'] ?>" <?= (old('jabatan_id', $_aparatur['jabatan_id']) == $jabatan['jabatan_id']) ? "selected" : "" ?>><?= $jabatan['jabatan_nama'] ?></option>
            <?php endforeach ?>
          </select>
          <div class="invalid-feedback">
