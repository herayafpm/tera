    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control col-sm-4 <?= ($_validation->hasError('jenis_uttp_nama') ? "is-invalid" : "") ?>" id="jenis_uttp_nama" name="jenis_uttp_nama" placeholder="Masukkan nama jenis" value="<?= old('jenis_uttp_nama') ?>">
        ...
        <div class="form-group">
          ...
          <select class="col-sm-4 custom-select <?= ($_validation->hasError('jenis_uttp_tipe_id') ? "is-invalid" : "") ?>" id="jenis_uttp_tipe_id" name="jenis_uttp_tipe_id">
            ...
            <?php foreach ($_jenis_uttp_tipes as $jenis_uttp_tipe) : ?>
              <option value="<?= $jenis_uttp_tipe['jenis_uttp_tipe_id'] ?>" <?= (old('jenis_uttp_tipe_id') == $jenis_uttp_tipe['jenis_uttp_tipe_id']) ? "selected" : "" ?>><?= $jenis_uttp_tipe['jenis_uttp_tipe_nama'] ?></option>
            <?php endforeach ?>
          </select>
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" name="jenis_uttp_tempat_pakai" id="jenis_uttp_tempat_pakai" <?= (old('jenis_uttp_tempat_pakai')) ? "checked" : "" ?>>
