...
<link rel="stylesheet" href="<?= base_url('assets/vendor') ?>/adminlte/plugins/summernote/summernote.min.css">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group row">
          <label for="tera_pengajuan_date_order" class="col-sm-2 col-form-label">Tanggal Booking</label>
          <div class="col-sm-4">
            <input type="date" class="form-control form-control-sm <?= ($_validation->hasError('tera_pengajuan_date_order') ? "is-invalid" : "") ?>" id="tera_pengajuan_date_order" name="tera_pengajuan_date_order" placeholder="Masukkan Tanggal Booking" value="<?= old('tera_pengajuan_date_order') ?>">
            <div class="invalid-feedback">
              <?= $_validation->getError('tera_pengajuan_date_order') ?>
            </div>
          </div>
        </div>
        <div class="form-group row">
          <label for="tera_pengajuan_keterangan" class="col-sm-2 col-form-label">Keterangan</label>
          <div class="col-sm-10">
            <textarea class="form-control form-control-sm <?= ($_validation->hasError('tera_pengajuan_keterangan') ? "is-invalid" : "") ?>" id="tera_pengajuan_keterangan" rows="3" name="tera_pengajuan_keterangan" placeholder="Masukkan Keterangan"><?= old('tera_pengajuan_keterangan') ?></textarea>
            <div class="invalid-feedback">
              <?= $_validation->getError('tera_pengajuan_keterangan') ?>
            </div>
          </div>
        </div>
        <div class="form-group row">
          <label for="petugas_ids" class="col-sm-2 col-form-label">Petugas</label>
          <div class="col-sm-10">
            <select class="petugas_ids form-control select2-danger form-control-sm <?= ($_validation->hasError('petugas_ids') ? "is-invalid" : "") ?>" id="petugas_ids" name="petugas_ids[]" multiple="multiple" data-dropdown-css-class="select2-danger" data-placeholder="Pilih Petugas">
              <option value="">-- Petugas --</option>
              <?php foreach ($_petugass as $petugas) : ?>
                <?php
                $selected = false;
                $search = array_search($petugas['admin_id'], old('petugas_ids', []));
                if ($search !== false) {
                  $selected = true;
                }
                ?>
                <option value="<?= $petugas['admin_id'] ?>" data-nama="<?= $petugas['admin_nama'] ?>" <?= $selected ? "selected" : "" ?>><?= $petugas['admin_nama'] ?></option>
              <?php endforeach; ?>
            </select>
            <div class="invalid-feedback">
              <?= $_validation->getError('petugas_ids') ?>
            </div>
          </div>
        </div>
...
<script src="<?= base_url('assets/vendor') ?>/adminlte/plugins/summernote/summernote.min.js"></script>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#tera_pengajuan_keterangan').summernote({
      height: 150,
