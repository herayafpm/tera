...
<tr>
  <td style="padding: 0 50px;" colspan="3">
    ...
    <p style="white-space:pre">3. Merk Kendaraan &#9;&#9;&#9;: <?= $tera_uttp['tera_uttp_merk_kendaraan'] ?></p>
    <p style="white-space:pre">4. No. Polisi dan No. Lambung &#9;: <?= $tera_uttp['tera_uttp_no_polisi'] ?></p>
    <p style="white-space:pre">5. Pemilik / Pemakai &#9;&#9;&#9;: <?= $tera['tera_atas_nama'] ?></p>
    <p style="white-space:pre">6. Diuji Oleh &#9;&#9;&#9;&#9;&#9;: <?= $tera_uttp['admin_nama'] ?> NIP. <?= $tera_uttp['admin_username'] ?></p>
    <p style="white-space:pre">7. Tanggal Pengujian &#9;&#9;&#9;: <?= date("d-m-Y", strtotime($tera_uttp['tera_uttp_pengujian_at'])) ?></p>
    <p style="white-space:pre">8. Metode &#9;&#9;&#9;&#9;&#9;: Perbandingan Langsung dengan standar</p>
    <div style="display: flex;">
      <div style="width:200px;margin-right:70px">9. Hasil Pengujian</div>
      <div>:</div>
